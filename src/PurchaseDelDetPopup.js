...
export default function ItemPopup({ open, handleClose, handlePurchaseDeleteData }) {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`${config.apiBaseUrl}/getpurDeleteDetails`, {
        ...
        body: JSON.stringify({ company_code: sessionStorage.getItem('selectedCompanyCode'), Location_Code: sessionStorage.getItem("selectedLocationCode"), transaction_no, transaction_date, vendor_code, vendor_name, purchase_type, pay_type }) // Send company_no and company_name as search criteria
      });
      if (response.ok) {
                      ...
                      <div class="col-md-12 text-center">
                        <div className="mb-0 d-flex justify-content-between">
                          <div className="mb-0 d-flex justify-content-start me-4">
                            <h1 className="h1">Purchase Del Help</h1>
                          </div>
                      ...
                      <div className="modal-body">
                        <div className="row ms-3 me-3">
                          ...
                          <div className="mb-2 mt-2 d-flex justify-content-end">
                            ...
                            <button type="button" className="" onClick={handleConfirm} title="Confirm">
                              <FontAwesomeIcon icon="fa-solid fa-check" />
                            </button>
                          </div>
                          <div className="ag-theme-alpine" style={{ height: '400px', width: '100%' }}>
