  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`${config.apiBaseUrl}/InventoryIssuedSearchData`, {
        ...
        body: JSON.stringify({ company_code: sessionStorage.getItem('selectedCompanyCode'), Location_Code: sessionStorage.getItem("selectedLocationCode"), IssuanceID, DateIssued, Issued_Type })
      });
      if (response.ok) {
