    ...
    return (
        <div>
            <div className="InvoiceContainer topnav-screen">
                <h2 className="d-flex justify-content-center fs-5 border border-bottom-0 mb-0 border-1 border-dark text-dark">TAX INVOICE</h2>
                        ...
                        <table className="" style={{
                            ...
                            <tbody>
                                ...
                                <tr className="small-row">
                                    <td className="">
                                        PO No:
                                        <strong>{headerData[0].po_no}</strong>
                                    </td>
                                    <td className="">
                                        PO Date:
                                        <strong>{new Date(headerData[0].po_date).toLocaleDateString('en-GB')}</strong>
                                    </td>
                                </tr>
                                <tr className="small-row">
                                    <td colSpan="2" className="">
                                        Document Type:
                                        <strong>{headerData[0].document_type}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td colSpan={2}>
