...
export default function TaxInvoicePopup({ open, handleClose, handletaxinvoice, invoicetype }) {
  ...
  const handleSearch = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${config.apiBaseUrl}/gettaxsearchdata`, {
        method: "POST",
        headers: {
                      ...
                      <div class="col-md-12 text-center">
                        <div className="p-0 bg-body-tertiary">
                          <div className="purbut mb-0 d-flex justify-content-between" >
                            <h1 align="left" className="purbut">{invoicetype === 'Proforma Invoice' ? 'Proforma Invoice' : 'Tax Invoice'}</h1>
                      ...
                      <div class="col-md-12 text-center">
                        <div className="mb-0 d-flex justify-content-between">
                          <div className="mb-0 d-flex justify-content-start me-4">
                            <h1 className="h1">{invoicetype === 'Proforma Invoice' ? 'Proforma Invoice' : 'Tax Invoice'}</h1>
                          </div>
