...
export default function StockTransferItemPopup({ open, handleClose, handleItem }) {
  ...
  const handleSearchItem = async () => {
    ...
    try {
      const response = await fetch(`${config.apiBaseUrl}/itempursearchdata`, {
        ...
        body: JSON.stringify({ Item_code, Item_variant, Item_name, Item_short_name, Item_Our_Brand, status,
