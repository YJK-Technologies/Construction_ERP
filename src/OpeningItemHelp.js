  ...
  const handleSearchItem = async () => {
    ...
    try {
      const response = await fetch(`${config.apiBaseUrl}/openingItemSearch`, {
        ...
        body: JSON.stringify({ company_code: sessionStorage.getItem('selectedCompanyCode'), Location_Code: sessionStorage.getItem("selectedLocationCode"), transaction_no, transaction_date, Item_code, Item_name }) // Send company_no and company_name as search criteria
      });
      if (response.ok) {
                      ...
                      <div class="col-md-12 text-center">
                        <div className="p-0 bg-body-tertiary">
                          <div className="purbut mb-0 d-flex justify-content-between" >
                            <h1 align="left" className="purbut">Opening Item Help</h1>
